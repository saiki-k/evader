Evader.extend(
	...
	(function () {
		const getNewEnemyPosition = (enemy) => {
			...
			const isEnemyAtBounds = isElementAtBounds(elements.enemies[enemy], elements.gameArea, {
		...
		const checkForPlayerCollisions = () => {
			...
			const isPlayerAtBounds = isElementAtBounds(elements.player, elements.gameArea, {
				boundAreaBorderWidth: gameArea.borderWidth,
				boundAreaBoundingRect: gameArea.boundingRect,
			});
