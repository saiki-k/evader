Evader.extend(
	...
	(function () {
		...
		const elements = {
			...
			enemies: {
				[`${enemyKeys[0]}`]: document.getElementById('enemy0'),
				[`${enemyKeys[1]}`]: document.getElementById('enemy1'),
				[`${enemyKeys[2]}`]: document.getElementById('enemy2'),
				[`${enemyKeys[3]}`]: document.getElementById('enemy3'),
			},
